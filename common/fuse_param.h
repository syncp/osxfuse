...
#define OSXFUSE_BUNDLE_PATH             OSXFUSE_BUNDLE_PREFIX "/Library/Filesystems/" OSXFUSE_NAME ".fs"
...
#define OSXFUSE_KEXT_NAME               OSXFUSE_NAME ".kext"
#define OSXFUSE_LOAD_PROG               OSXFUSE_RESOURCES_PATH "/load_" OSXFUSE_NAME
#define OSXFUSE_MOUNT_PROG              OSXFUSE_RESOURCES_PATH "/mount_" OSXFUSE_NAME
